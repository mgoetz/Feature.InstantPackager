...
namespace Velir.SitecoreLibrary.Modules.InstantPackager.Test.Filters.InstantPackageStatusFilters
{
	[Category("InstantPackageFilters")]
	[TestFixture]
	class IfInstantPackageIsNotEmptyHideTest
	{
		...
		#region Hide()
		[Test]
		public void Hide_IsEmptyReturnsFalse()
		{
			//Arrange
			IfInstantPackageIsNotEmptyHide testObject = new IfInstantPackageIsNotEmptyHide(new TestCache());
		...
		[Test]
		public void Hide_HasOneItemReturnsTrue()
		{
			//Arrange
			IfInstantPackageIsNotEmptyHide testObject = new IfInstantPackageIsNotEmptyHide(new TestCache());
		...
		[Test]
		public void Hide_HasSeveralItemsReturnsTrue()
		{
			//Arrange
			IfInstantPackageIsNotEmptyHide testObject = new IfInstantPackageIsNotEmptyHide(new TestCache());
			_testInstantPackageManager.AddItem(_testItemKey1);
