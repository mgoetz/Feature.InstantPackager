...
namespace Sitecore.SharedSource.InstantPackager.Utils.Test.Filters.RelatedItemFilters
{
	[Category("InstantPackageFilters")]
	[TestFixture]
	internal class IfAnySubItemsInInstantPackageHideTest
	{
		...
		[Test]
		public void Hide_ContainsOneSubItemReturnsTrue()
		{
			//Arrange
			IfAnySubItemsInInstantPackageHide testObject = new IfAnySubItemsInInstantPackageHide(new TestCache());
		...
		[Test]
		public void Hide_ContainsSomeSubItemsReturnsTrue()
		{
			//Arrange
			IfAnySubItemsInInstantPackageHide testObject = new IfAnySubItemsInInstantPackageHide(new TestCache());
			List<IItemKey> subItems = new List<IItemKey>() { _testSubItemKey1, _testSubItemKey2, _testSubItemKey3, _testSubItemKey4 };
		...
		[Test]
		public void Hide_ContainsAllSubItemsReturnsTrue()
		{
			//Arrange
			IfAnySubItemsInInstantPackageHide testObject = new IfAnySubItemsInInstantPackageHide(new TestCache());
			List<IItemKey> subItems = new List<IItemKey>() { _testSubItemKey1, _testSubItemKey2, _testSubItemKey3, _testSubItemKey4 };
		...
		[Test]
		public void Hide_DoesNotContainAnySubItemsReturnsFalse()
		{
			//Arrange
			IfAnySubItemsInInstantPackageHide testObject = new IfAnySubItemsInInstantPackageHide(new TestCache());
			List<IItemKey> subItems = new List<IItemKey>() { _testSubItemKey1, _testSubItemKey2, _testSubItemKey3, _testSubItemKey4 };
		...
		[Test]
		public void Hide_EmptyListReturnsFalse()
		{
			//Arrange
			IfAnySubItemsInInstantPackageHide testObject = new IfAnySubItemsInInstantPackageHide(new TestCache());
			List<IItemKey> subItems = new List<IItemKey>(){_testSubItemKey1, _testSubItemKey2, _testSubItemKey3, _testSubItemKey4};
